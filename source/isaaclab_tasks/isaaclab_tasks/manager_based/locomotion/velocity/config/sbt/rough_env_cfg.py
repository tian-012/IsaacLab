...
class SBTRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        super().__post_init__()
        # Scene
        self.scene.robot = SBT_MINIMAL_CFG.replace(prim_path="{ENV_REGEX_NS}/sbt_v1_3")
        self.scene.height_scanner.prim_path = "{ENV_REGEX_NS}/sbt_v1_3/base_link"
        self.scene.contact_forces.prim_path = "{ENV_REGEX_NS}/sbt_v1_3/.*"
        # Randomization
        ...
        # terminations
        self.terminations.base_contact.params["sensor_cfg"].body_names = ["base_link",".*_knee"]


@configclass
class SBTRoughEnvCfg_PLAY(SBTRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
